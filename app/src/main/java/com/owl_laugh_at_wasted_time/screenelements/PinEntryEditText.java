...
public class PinEntryEditText extends AppCompatEditText {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, com.alimuzaffar.lib.pin.R.styleable.PinEntryEditText, 0, 0);
        try {
            TypedValue outValue = new TypedValue();
            ta.getValue(com.alimuzaffar.lib.pin.R.styleable.PinEntryEditText_pinAnimationType, outValue);
            mAnimatedType = outValue.data;
            mMask = ta.getString(com.alimuzaffar.lib.pin.R.styleable.PinEntryEditText_pinCharacterMask);
            mSingleCharHint = ta.getString(com.alimuzaffar.lib.pin.R.styleable.PinEntryEditText_pinRepeatedHint);
            mLineStroke = ta.getDimension(com.alimuzaffar.lib.pin.R.styleable.PinEntryEditText_pinLineStroke, mLineStroke);
            mLineStrokeSelected = ta.getDimension(com.alimuzaffar.lib.pin.R.styleable.PinEntryEditText_pinLineStrokeSelected, mLineStrokeSelected);
            mSpace = ta.getDimension(com.alimuzaffar.lib.pin.R.styleable.PinEntryEditText_pinCharacterSpacing, mSpace);
            mTextBottomPadding = ta.getDimension(com.alimuzaffar.lib.pin.R.styleable.PinEntryEditText_pinTextBottomPadding, mTextBottomPadding);
            mIsDigitSquare = ta.getBoolean(com.alimuzaffar.lib.pin.R.styleable.PinEntryEditText_pinBackgroundIsSquare, mIsDigitSquare);
            mPinBackground = ta.getDrawable(com.alimuzaffar.lib.pin.R.styleable.PinEntryEditText_pinBackgroundDrawable);
            ColorStateList colors = ta.getColorStateList(com.alimuzaffar.lib.pin.R.styleable.PinEntryEditText_pinLineColors);
            if (colors != null) {
                mColorStates = colors;
            }
        } finally {
        ...
        TypedValue outValue = new TypedValue();
        context.getTheme().resolveAttribute(com.alimuzaffar.lib.pin.R.attr.colorControlActivated,
                outValue, true);
        int colorSelected = outValue.data;
        mColors[0] = colorSelected;

        int colorFocused = isInEditMode() ? Color.GRAY : ContextCompat.getColor(context, com.alimuzaffar.lib.pin.R.color.pin_normal);
        mColors[1] = colorFocused;

        int colorUnfocused = isInEditMode() ? Color.GRAY : ContextCompat.getColor(context, com.alimuzaffar.lib.pin.R.color.pin_normal);
